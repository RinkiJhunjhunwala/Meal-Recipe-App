...
class _PizzaState extends State<Pizza> {
  ...
  Future<void> loadMeals() async {
    ...
    List<String>? meals = prefs.getStringList('Pizza_meals');
    if (meals != null) {
      setState(() {
    ...
    MenuItem(
      ...
      steps: ['Take pizza bread', 'Put sauce', 'Put cheese'],
      ),
    MenuItem(
      name: 'Chicken Pizza', 
      isVeg: false, 
      ...
      isGlutenFree: false, 
      isLactoseFree: false,
      ingredients: ['Bread', 'Sauce', 'Chicken'],
      steps: ['Take pizza bread', 'Put sauce', 'Put chicken'],
      ),
    MenuItem(
      ...
      isGlutenFree: true, 
      isLactoseFree: false,
      ingredients: ['Bread', 'Sauce', 'Gluten free Cheese'],
      steps: ['Take pizza bread', 'Put sauce', 'Put cheese'],
      ),
    MenuItem(
      ...
      isGlutenFree: false, 
      isLactoseFree: true,
      ingredients: ['Bread', 'Sauce', 'Lactose free Cheese'],
      steps: ['Take pizza bread', 'Put sauce', 'Put cheese'],
      ),
    MenuItem(
      name: 'Paneer Pizza', 
      ...
      steps: ['Take pizza bread', 'Put sauce', 'Put paneer'],
      ),
  ];
      saveMeals();
    }
  ...
  Future<void> saveMeals() async {
    ...
    await prefs.setStringList('Pizza_meals', meals);
  }
