...
class _BurgerState extends State<Burger> {
  ...
  Future<void> loadMeals() async {
    ...
    List<String>? meals = prefs.getStringList('burger_meals');
    if (meals != null) {
      setState(() {
      ...
      items = [
        MenuItem(
          ...
          isGlutenFree: false, 
          isLactoseFree: false,
          ingredients: ['Bread', 'Lettuce', 'Cheese'],
          steps: ['Take two bread', 'Put lettuce', 'Put cheese'],
        ),
        MenuItem(
          name: 'Chicken Burger', 
          isVeg: false, 
          ...
          steps: ['Take two bread', 'Put chicken', 'Put cheese'],
        ),
        MenuItem(
          ...
          isGlutenFree: true, 
          isLactoseFree: false,
          ingredients: ['Bread', 'Lettuce', 'Gluten free Cheese'],
          steps: ['Take two bread', 'Put lettuce', 'Put cheese'],
        ),
        MenuItem(
          name: 'Lactose-Free Burger', 
          isVeg: false, 
          isNonVeg: false, 
          isGlutenFree: false, 
          isLactoseFree: true,
          ingredients: ['Bread', 'Lettuce', 'Lactose-free Cheese'],
          steps: ['Take two bread', 'Put lettuce', 'Put cheese'],
        ),
        MenuItem(
          name: 'Veggie Burger', 
          ...
          steps: ['Take two bread', 'Put lettuce and tomato', 'Put cheese'],
        ),
      ];
      saveMeals();
    }
  ...
  Future<void> saveMeals() async {
    ...
    await prefs.setStringList('burger_meals', meals);
  }
