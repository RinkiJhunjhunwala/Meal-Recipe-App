...
class _DessertsState extends State<Desserts> {
  ...
  Future<void> loadMeals() async {
    ...
    List<String>? meals = prefs.getStringList('Desserts_meals');
    if (meals != null) {
      setState(() {
    ...
    MenuItem(
      ...
      isGlutenFree: false, 
      isLactoseFree: false,
      ingredients: ['Dough', 'Chocolate', 'Sugar Syrup'],
      steps: ['Bake dough', 'Add sugar syrup', 'Put chocolate'],
      ),
    MenuItem(
      name: 'Egg Brownie', 
      isVeg: false, 
      ...
      isGlutenFree: false, 
      isLactoseFree: false,
      ingredients: ['Dough', 'Chocolate', 'Egg'],
      steps: ['Bake dough', 'Add egg', 'Put chocolate'],
      ),
    MenuItem(
      ...
      isGlutenFree: true, 
      isLactoseFree: false,
      ingredients: ['Dough', 'Gluten free Chocolate', 'Sugar Syrup'],
      steps: ['Bake dough', 'Add sugar syrup', 'Put chocolate'],
      ),
    MenuItem(
      name: 'Lactose-Free Dessert', 
      isVeg: false, 
      isNonVeg: false, 
      isGlutenFree: false, 
      isLactoseFree: true,
      ingredients: ['Dough', 'Lactose free Chocolate', 'Sugar Syrup'],
      steps: ['Bake dough', 'Add sugar syrup', 'Put chocolate'],
      ),
    MenuItem(
      name: 'Chocolate Gluten-free Brownie', 
      isVeg: true, 
      isNonVeg: false, 
      isGlutenFree: true, 
      isLactoseFree: false,
      ingredients: ['Dough', 'Chocolate', 'Gluten free Sugar Syrup'],
      steps: ['Bake dough', 'Add sugar syrup', 'Put chocolate'],
      ),
  ];
      saveMeals();
  ...
  Future<void> saveMeals() async {
    ...
    await prefs.setStringList('Desserts_meals', meals);
  }
