...
class _ChineseState extends State<Chinese> {
  ...
  Future<void> loadMeals() async {
    ...
    List<String>? meals = prefs.getStringList('chinese_meals');
    if (meals != null) {
      setState(() {
    ...
    MenuItem(
      ...
      steps: ['Boil noodles', 'Stir-fry vegetables', 'Mix together'],
    ),
    MenuItem(
      ...
      isGlutenFree: false,
      isLactoseFree: false,
      ingredients: ['Noodles', 'Chicken', 'Soy Sauce'],
      steps: ['Boil noodles', 'Cook chicken', 'Mix together'],
    ),
    MenuItem(
      name: 'Gluten-Free Dimsums',
      isVeg: false,
      isNonVeg: false,
      isGlutenFree: true,
      isLactoseFree: false,
      ingredients: ['Gluten-free flour', 'Vegetables', 'Soy Sauce'],
      steps: ['Prepare dough', 'Fill with vegetables', 'Steam'],
    ),
    MenuItem(
      name: 'Lactose-Free Dimsums',
      isVeg: false,
      isNonVeg: false,
      isGlutenFree: false,
      isLactoseFree: true,
      ingredients: ['Flour', 'Vegetables', 'Soy Sauce'],
      steps: ['Prepare dough', 'Fill with vegetables', 'Steam'],
    ),
    MenuItem(
      name: 'Egg Chowmein',
      ...
      steps: ['Boil noodles', 'Scramble eggs', 'Mix together'],
    ),
  ];
      saveMeals();
    }
  ...
  Future<void> saveMeals() async {
    ...
    await prefs.setStringList('chinese_meals', meals);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chinese', style: TextStyle(fontWeight: FontWeight.bold)),
